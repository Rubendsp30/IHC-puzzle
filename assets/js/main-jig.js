...
window.onload = function () {
    ...
    selected_puzzle = "assets/puzzles/jiggsaw/" + puzzle_choice + "/";
    ...
    const piecesBlockImg = document.getElementsByClassName("jig");
    for (let i = 0; i < piecesBlock.length; i++) {
        var image = selected_puzzle+"piece-"+pieces[i]+".png";
        piecesBlockImg[i].src=image;
        piecesBlockImg[i].classList.add("peca-"+pieces[i]);
        /*piecesBlockImg[i].classList.add("normal");*/
    ...
    for (let i = 0; i < 12; i++) {
        ...
        //piecesBlockImg[lockInd].src="";
        piecesBlockImg[lockInd].classList.add("hide");
        var image = "url(assets/images/lock.png)";
        piecesBlock[lockInd].style.backgroundImage = image;
        piecesBlock[lockInd].style.backgroundSize = "cover";
        piecesBlock[lockInd].style.backgroundRepeat = "no-repeat";
        piecesBlock[lockInd].style.backgroundColor = "white";
    ...
    if (shuffledQuestions.length > currentQuestionIndex + 1) {
        setTimeout(() => {
            if (!correct) {
                ...
                imgUnlock=selectedButton.unlockPiece.split('-');
                var text="peca-"+imgUnlock[1];
                const imgblock=document.getElementsByClassName(text);
                imgblock[0].classList.remove('hide');
                unlockedPiece[0].style.backgroundSize = "";
                unlockedPiece[0].style.backgroundRepeat = "";
                unlockedPiece[0].style.backgroundColor = "";
                unlockedPiece[0].classList.add('draggable');
                unlockedPiece[0].style.backgroundImage = "";
            }
